...
urlpatterns = [
    ...
    path("addpolice", views.add_police, name="addpolice"),
    path("Complaintstatus", views.Complaintstatus, name="Complaintstatus"),
    path("AddMissing", views.AddMissing, name="AddMissing"),
    path("AddMissingpublic", views.AddMissingpublic, name="AddMissingpublic"),
    ...
    path("Missing_details_public", views.Missing_details_public, name="Missing_details_public"),
    ...
    path("addcriminalspublic", views.addcriminalspublic, name="addcriminalspublic"),
     path("addcriminalspublic", views.addcriminalspublic, name="addcriminalspublic"),
    ...
    path("addcrimepublic", views.addcrimepublic, name="addcrimepublic"),
